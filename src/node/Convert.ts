 ...
 */
export function convertDegreeToMatrix(heading_degree: number): AeroflyMatrix3Float {
    // TODO: This implementation is not correct
 ...
 * @see
 */
export function convertMatrixToDegree(orientation: AeroflyMatrix3Float): number {
