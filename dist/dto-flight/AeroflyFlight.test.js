...
describe("AeroflyFlight", () => {
    it("should create a valid AeroflyFlight structure", () => {
        const flight = new AeroflyFlight(new AeroflySettingsAircraft("c172", "highway_patrol"), AeroflySettingsFlight.createInCartesian([-1548480.29141299, -4793879.34075889, 3903092.08870457], [0, 0, 0], [
            ...
            airport: "KTEX",
        }), AeroflyTimeUtc.createFromComponents(2026, 3, 1, 21.343333), AeroflySettingsWind.createWithNormalizedValues(0.672604, 70, 0.15, 0.72), [
