...
export class AeroflySettingsWind {
     ...
     */
    constructor(speed_kts, directionInDegree, gust_kts = 0, temperature_celsius = 14) {
     ...
     */
    static createWithNormalizedValues(strength, directionInDegree, turbulence = 0, thermalActivity = 0) {
    ...
    set thermalActivity(thermalActivity) {
    ...
    getElement() {
        return new AeroflyConfigurationNode("tmsettings_wind", "wind")
            ...
            .appendChild("float64", "thermal_activity", this.thermalActivity, `${Math.round(this.temperature_celsius)}°C`);
    }
    /**
