...
export class AeroflyMission {
    ...
    toString() {
        ...
        if (this.tutorialName !== null) {
            optionalProperties.push(`                <[string8][tutorial_name][${this.tutorialName}]> // Opens https://www.aerofly.com/aircraft-tutorials/${this.tutorialName}`);
        }
...
${this.getLocalizedTextsString()}
        ...
        if (this.isScheduled !== null) {
            moreOptionalProperties.push(`                <[bool]      [is_scheduled]       [${this.isScheduled ? "true" : "false"}]>`);
        }
        if (this.finish !== null) {
